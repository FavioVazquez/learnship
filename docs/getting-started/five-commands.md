...
learnship has 57 workflows. You don't need to know them all. Start with these five: everything else surfaces naturally from `/ls` as you need it.
...
Lists all 57 workflows organized by category with one-line descriptions. Use this when you want to check if a specific capability exists: scope changes, debugging workflows, decision logging, milestone management, and more.
...
Session 3:  /ls                 ← resume
            ...
            /review             ← two-pass review: spec compliance then multi-persona quality
