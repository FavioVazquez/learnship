...
- **Claude Code** — `/home/ec2-user/favio/agentic-development/.windsurf/learnship/skills/` rebuilt with updated skill content + rewritten `references/` paths
...
All platforms updated (installer re-run):
  ...
  Claude Code    ✓ /home/ec2-user/favio/agentic-development/.windsurf/learnship/skills/ rebuilt
